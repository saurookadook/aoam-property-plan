...
const analysis: PropertyAnalysisData = {
  report: {
...
const meta = {
  title: 'pages/properties/PropertyOverview/components/MetricGrid',
  component: MetricGrid,
  parameters: { layout: StoryLayout.padded },
} as Meta<typeof MetricGrid>;

export default meta;
type Story = StoryObj<typeof MetricGrid>;

export const GoodConfidence: Story = {
  args: { analysis, confidence: 'good' },
};
...
export const LowConfidence: Story = {
  args: {
    analysis: {
      ...analysis,
      report: { ...analysis.report, coc_return_percentage: 9.4 },
    },
    confidence: 'low',
  },
};
