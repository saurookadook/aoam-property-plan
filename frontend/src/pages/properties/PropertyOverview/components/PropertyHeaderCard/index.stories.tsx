...
import { PropertyHeaderCard } from './index';
...
const meta = {
  title: 'pages/properties/PropertyOverview/components/PropertyHeaderCard',
  component: PropertyHeaderCard,
  parameters: { layout: StoryLayout.padded },
} as Meta<typeof PropertyHeaderCard>;

export default meta;
type Story = StoryObj<typeof PropertyHeaderCard>;

export const CopOnly: Story = {
  args: { property, rate: null },
};
