...
def upgrade() -> None:
    ...
    op.create_table('property_comps',
    ...
    sa.ForeignKeyConstraint(['listing_id'], ['listings.id'], name=op.f('property_comps_listing_id_fkey')),
    sa.ForeignKeyConstraint(['property_id'], ['properties.id'], name=op.f('property_comps_property_id_fkey')),
    sa.PrimaryKeyConstraint('id', name=op.f('property_comps_pkey')),
    sa.UniqueConstraint('property_id', 'listing_id', name=op.f('property_comps_property_id_listing_id_key'))
    )
